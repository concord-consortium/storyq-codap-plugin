		...
		return (
			<div className='sq-training-pane'>
				<div className='sq-component'>
					...
					<p>This model will be trained using {this.props.domainStore.targetStore.targetDatasetInfo.name + ' '}
						with {this.props.domainStore.featureStore.features.length} <strong>computed {tFeatureString}:</strong></p>
					{featureList()}
				</div>
				{getButtons()}
				{getSettingsPanel()}
