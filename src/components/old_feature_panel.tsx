...
export class OldFeaturePanel extends Component<FM_Props, FM_StateTypes> {
	[index: string]: any;
...
*/
	...
	private async getTargetAttributeNames(): Promise<string[]> {
		...
		return getAttributeNames(this.targetDatasetInfo.name, this.targetCollectionName)
	}
	...
	public render() {
		switch (this.state.status) {
			case 'error':
				return OldFeaturePanel.renderForErrorState();
			case 'active':
			case 'inProgress':
